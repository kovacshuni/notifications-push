...
func Push(reg dispatch.Registrar, apiGatewayApiKeyValidationURL string, httpClient *http.Client) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		apiKey := getApiKey(r)
		if isValid, errMsg, errStatusCode := isValidApiKey(apiKey, apiGatewayApiKeyValidationURL, httpClient); !isValid {
